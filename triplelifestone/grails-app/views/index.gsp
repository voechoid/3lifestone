<%
    ...
    def navigationItems=[
        '系统管理': """{title: '系统管理', border:false, html: '<a id="sysUser" href="#"><center><img src="/triplelifestone/images/group.png"/><br>用户</center></a><a id="sysRole" href="#"><center><img src="/triplelifestone/images/group.png"/><br>角色</center></a>',iconCls: 'settings'}"""
    ]
%>

<html>
<head>
  <title>[:] -- 3lifestone 提供支持</title>
...
<%
        ...
        function addTab(domain, chn) {
            ...
            var url ="<iframe src='/triplelifestone/"+domain+"/index' scrolling='auto' frameborder='0' style='width:100%; height:100%;overflow:hidden;'/>";
