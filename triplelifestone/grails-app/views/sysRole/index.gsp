...
<html>
    ...
    var sysRoleCreateForm = new Ext.form.FormPanel({
        ...
        labelWidth: 80,
        frame: true,
        url: '/triplelifestone/sysRole/createJSON',
        defaults:{ width:250},
        items: [
    ...
    var sysRoleUpdateForm = new Ext.form.FormPanel({
        ...
        labelWidth: 80,
        frame: true,
        url: '/triplelifestone/sysRole/updateJSON',
        defaults:{ width:250},
        items: [
            {fieldLabel:'id',name: 'id',xtype: 'numberfield',hidden:true,hideLabel:true},
            {fieldLabel: '编码',name: 'code',xtype: 'textfield', allowBlank: false, blankText: '编码为必填项', maxLength: 16, maxLengthText: '编码至多包含16个字符', minLength: 4, minLengthText: '编码至少包含4个字符'},
    ...
    var sysRoleDetailForm = new Ext.form.FormPanel({
        ...
        labelWidth: 80,
        frame: true,
        url: '/triplelifestone/sysRole/detailJSON',
        defaults:{ width:250},
        items: [
            {fieldLabel:'id',name: 'id',xtype: 'numberfield',hidden:true,hideLabel:true},
    ...
    tb.add({
        text: '新建',
        icon: '/triplelifestone/images/skin/database_add.png',
        handler:function() {
        ...
        text: '修改',
        icon: '/triplelifestone/images/skin/database_edit.png',
        handler: function() {
            ...
            if (id == null) {
                ...
                sysRoleUpdateForm.getForm().load({
                    url:'/triplelifestone/sysRole/detailJSON?id=' + id,
        ...
        text: '删除',
        icon: '/triplelifestone/images/skin/database_delete.png',
        handler: function() {
            ...
            if (count == 0) {
                ...
                Ext.MessageBox.confirm('信息', '您确定删除编号为' + id + '的记录吗?', function(btn) {
                    if (btn == 'yes') {
                        Ext.Ajax.request({
                            url: '/triplelifestone/sysRole/deleteJSON',
                            params: {id:id},
        ...
        text: '详细',
        icon: '/triplelifestone/images/skin/database_save.png',
        handler: function() {
            var id = (grid.getSelectionModel().getSelected()).id;
            if (id == null) {
    ...
    }, '->',
    {
        ...
        text: '搜索',
        icon: '/triplelifestone/images/skin/database_search.png',
        handler: function() {
        }
    });
    ...
    var store = new Ext.data.Store({
        autoLoad:true,
        proxy: new Ext.data.HttpProxy({url:'/triplelifestone/sysRole/listJSON'}),
