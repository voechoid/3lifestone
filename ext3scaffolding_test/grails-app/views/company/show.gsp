	...
	<body>
		...
		<div id="show-company" class="content scaffold-show" role="main">
			...
			<ol class="property-list company">
				...
				<g:if test="${companyInstance?.settingUpDate}">
				<li class="fieldcontain">
					<span id="settingUpDate-label" class="property-label"><g:message code="company.settingUpDate.label" default="Setting Up Date" /></span>
					
						<span class="property-value" aria-labelledby="settingUpDate-label"><g:formatDate date="${companyInstance?.settingUpDate}" /></span>
					
				</li>
				</g:if>
			
				<g:if test="${companyInstance?.summary}">
				<li class="fieldcontain">
					<span id="summary-label" class="property-label"><g:message code="company.summary.label" default="Summary" /></span>
					
						<span class="property-value" aria-labelledby="summary-label"><g:fieldValue bean="${companyInstance}" field="summary"/></span>
